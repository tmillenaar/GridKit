...
shifted_grid = HexGrid(size=10, shape="pointy", offset=(main_grid.dx/2, (main_grid.dy/2)+main_grid.r))
...
half_size_grid = HexGrid(size=main_grid.dx/2, offset=(0, main_grid.dy/(2*2)), shape="pointy")
third_size_grid = HexGrid(size=main_grid.dx/3, offset=(0, main_grid.dy/(2*3)), shape="pointy")
