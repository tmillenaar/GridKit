...
# nocheckin, This is a clone of resampling.py and should not be merged into main
# sphinx_gallery_thumbnail_number = -1

from gridkit import RectGrid, TriGrid, read_raster
...
rectdem = dem.resample(RectGrid(dx=4, dy=4, crs=dem.crs), method="bilinear")
...
hexdem_flat = dem.resample(
    TriGrid(area=rectdem.area, orientation="flat", crs=dem.crs), method="bilinear"
)
hexdem_pointy = dem.resample(
    TriGrid(area=rectdem.area, orientation="pointy", crs=dem.crs), method="bilinear"
)
